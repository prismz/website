...
<h3>why i love the c programming language</h3>

<h4>why not a newer/easier language?</h4>
<p>
...
<p>a prime example of a script that <i>needed</i> to be written in c was my script that centers my cursor on startup
    ...
    can view the script <a href="/m/center_cursor.c">here</a>.
</p>
